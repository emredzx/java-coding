 ...
 * @author Emredz
 */
public class DownloadCompleted extends javax.swing.JFrame {

    /**
     * Creates new form DownloadCompleted
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DownloadCompleted.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DownloadCompleted().setVisible(true);
            }
        });
    }
